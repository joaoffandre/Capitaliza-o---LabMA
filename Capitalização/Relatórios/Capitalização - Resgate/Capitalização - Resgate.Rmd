...
1-3-1 e 2-3-1 viram 5-5-5 

#### Antes de agrupar
```{r fig.width=10, fig.height=6}
base_resgate1_5 <- base_resgate1 |>
  filter(combinação %in% c('1-3-1', '2-3-1'))
...
1-1-1, 1-1-2, 2-1-2 viram 7-7-7

#### Antes de agrupar
```{r fig.width=10, fig.height=6}
base_resgate1_7 <- base_resgate1 |>
  filter(combinação %in% c('1-1-1', '1-1-2', '2-1-2'))
