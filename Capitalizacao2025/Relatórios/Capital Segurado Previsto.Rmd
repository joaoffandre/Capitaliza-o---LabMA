---
title: "Capital Segurado Previsto - Capitalização"
output:
  html_document:
    toc: true
    toc_float: true
...
quartis <- quantile(base$capitalSeguradoPrevisto, probs = c(0, 0.25, 0.5, 0.75, 1), na.rm = TRUE)

base$faixaCapitalSeguradoPrevisto <- cut(base$capitalSeguradoPrevisto,
                                         breaks = quartis,
                                         labels = c("Muito Baixo", "Baixo", "Medio", "Alto"),
                                         include.lowest = TRUE)
